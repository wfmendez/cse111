def main():
    ...
    if vin in vehicles_dict:
        ...
        manufacturer_vehicle = vehicle[MANUFACTURER_INDEX]
        model_vehicle = vehicle[MODEL_INDEX]
        color_vehicle = vehicle[COLOR_INDEX]
        # Print the manufacturer, model, and color of the vehicle.
        # Don't print the year, engine design, or displacement.
        print(f"{manufacturer_vehicle} {model_vehicle} {color_vehicle}")
